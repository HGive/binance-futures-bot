...
logging.info("***************  Matts Bot has started!! ***************")
...
def main() :
    ...
    while True:
        try:
            ...
            market_cond = (highest_last_40*0.992 >= currClose ) if is_bull else (highest_last_40*0.99 >= currClose or rsi <= 35) 
