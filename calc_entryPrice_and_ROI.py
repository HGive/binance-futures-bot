...
# buy_percent = [0.04, 0.12, 0.7, 1]  # 각 매수 퍼센트 (1차, 2차, 3차, 4차 매수)
# price_diffs = [1, 0.97, 0.96, 0.94]  # 각 매수 시점에서의 가격 변동 비율

buy_percent = [0.25, 1]  # 각 매수 퍼센트 (1차, 2차, 3차, 4차 매수)
price_diffs = [1, 0.96]  # 각 매수 시점에서의 가격 변동 비율

# buy_percent = [0.02, 0.05, 0.15, 0.5, 1]  # 각 매수 퍼센트 (1차, 2차, 3차, 4차 매수)
# price_diffs = [  1, 0.98, 0.97, 0.96, 0.95]  # 각 매수 시점에서의 가격 변동 비율
